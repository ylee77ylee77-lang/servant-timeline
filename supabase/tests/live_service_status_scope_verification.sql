...
select pg_temp.assert_true(
  (select count(*) = 1 and bool_and(user_id = '81000000-0000-4000-8000-000000000003') from public.service_coordinators),
  'deputy can read unrelated service coordinators'
);
select pg_temp.assert_true(
